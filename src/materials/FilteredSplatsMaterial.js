...
FilteredSplatsMaterial.prototype.render = function(sceneNode, camera, lights){
...
FilteredSplatsMaterial.prototype.renderPointClouds = function(transform, pointClouds, camera, lights){
	...
	// attributes
	this.colorPass(transform, pointClouds, camera);
	if(this.illuminationMode == IlluminationMode.PHONG || this.illuminationMode == IlluminationMode.NORMALS){
		this.normalPass(transform, pointClouds, camera);
	}
	
	// normalization and shading
	this.shadingPass(oldBuffer, camera, lights);
 ...
 * 
 */
FilteredSplatsMaterial.prototype.depthPass = function(transform, pointClouds, camera){
...
FilteredSplatsMaterial.prototype.colorPass = function(transform, pointClouds, camera){
	// color fbo
	this.colorFBO.bind();
...
FilteredSplatsMaterial.prototype.normalPass = function(transform, pointClouds, camera){
	// normal fbo
	this.normalFBO.bind();
 ...
 * 
 */
FilteredSplatsMaterial.prototype.shadingPass = function(oldBuffer, camera, lights){
	oldBuffer.bind();
